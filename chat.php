...
if(!isset($_SESSION['Unique_id'])){
  ...
  $query = $conn->query("Select * from users Where username='$user' || Phone='$user' ");


  $show = mysqli_fetch_array($query);
  $Unique_id = $show['Unique_id'];
...
<html>
  ...
  <body>
    <style type="text/css">
      ...
      margin: 0;
      background: #753896;
         background: -webkit-linear-gradient(to right, #c13584, #5851db, #fd1d1d);
          background: linear-gradient(to right, #A46DFF, #86A8E7, #A46DFF);
    }
      ...
      <div class="row justify-content-center h-100">
        <div class="col-md-4 col-xl-3 chat"><div class="card mb-sm-3 mb-md-0 contacts_card">
          ...
          <div class="card-body contacts_body">
            ...
            <p>Email: <strong style="font-size: 14px"><?php echo $show['email'];?></strong></p>
        ...
        <div class="col-md-8 col-xl-6 chat">
          <div class="card">
            ...
            <!--start of admin -->  
            <?php
                $sql ="SELECT * from mess where Unique_id=$Unique_id ";
